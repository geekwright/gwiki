                    ...
                    <td class="<{cycle values="even,odd"}>">
                        <{if $element.name == 'gwikieditbuttons'}>
                            <div class="wikieditor-buttontray" id="wikieditor-buttons-reg">
                                <a onclick="addSimpleMarkup('**','**'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_BOLD}>" class="wikieditor-button wikieditor-button-bold"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('//','//'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_ITALIC}>" class="wikieditor-button wikieditor-button-italic"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('__','__'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_UNDERLINE}>" class="wikieditor-button wikieditor-button-underline"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('--','--'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_STRIKE}>" class="wikieditor-button wikieditor-button-strike"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup(',,',',,'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_SUBSCRIPT}>" class="wikieditor-button wikieditor-button-subscript"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('^^','^^'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_SUPERSCRIPT}>" class="wikieditor-button wikieditor-button-superscript"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('##','##'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_CODE}>" class="wikieditor-button wikieditor-button-code"><div>&nbsp;</div></a>
                                <a onclick="buttonGetParams(event,'wikieditor-popform-color'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_COLOR}>" class="wikieditor-button wikieditor-button-color"><div>&nbsp;</div></a>
                            </div>
                            <div class="wikieditor-buttontray">
                                <a onclick="addSimpleMarkup('[[',']]'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_LINK}>" class="wikieditor-button wikieditor-button-link"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('{{','}}'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_IMAGE}>" class="wikieditor-button wikieditor-button-image"><div>&nbsp;</div></a>
                            </div>
                            <div class="wikieditor-buttontray">
                                <a onclick="buttonGetParams(event,'wikieditor-popform-header'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_HEADER}>" class="wikieditor-button wikieditor-button-header"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\\\\',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_LINEBREAK}>" class="wikieditor-button wikieditor-button-linebreak"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\n> ',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_QUOTE}>" class="wikieditor-button wikieditor-button-quote"><div>&nbsp;</div></a>
                                <a onclick="buttonGetParams(event,'wikieditor-popform-indent'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_INDENT}>" class="wikieditor-button wikieditor-button-indent"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\n----\n',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_HORIZONTALRULE}>" class="wikieditor-button wikieditor-button-horizontalrule"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\n* ',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_BULLETLIST}>" class="wikieditor-button wikieditor-button-bulletlist"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\n# ',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_ORDEREDLIST}>" class="wikieditor-button wikieditor-button-orderedlist"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('\n++ ',''); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_CENTER}>" class="wikieditor-button wikieditor-button-center"><div>&nbsp;</div></a>
                                <a onclick="addSimpleMarkup('{{{','}}}'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_NOWIKI}>" class="wikieditor-button wikieditor-button-nowiki"><div>&nbsp;</div></a>
                                <a onclick="buttonGetParams(event,'wikieditor-popform-boxes'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_BOXES}>" class="wikieditor-button wikieditor-button-boxes"><div>&nbsp;</div></a>
                                <a onclick="buttonGetParams(event,'wikieditor-popform-ref'); return false;" title="<{$smarty.const._MD_GWIKI_EDIT_BTN_REFERENCE}>" class="wikieditor-button wikieditor-button-ref"><div>&nbsp;</div></a>
                            </div>
                        <{else}>
                            <{$element.body}>
                        <{/if}>
...
<div class="wikieditor-buttontray">
   ...
   <a onclick="bigWindow(0); return false;"><img src="<{$gwiki.modurl}>/assets/images/closeicon.png" alt="<{$smarty.const._MD_GWIKI_FULLSCREEN_EXIT}>" title="<{$smarty.const._MD_GWIKI_FULLSCREEN_EDIT}>"/></a>
            ...
            <textarea id="editfield" onclick="setWikiChanged();" style="width:100%; height:94%; overflow:auto; border:0; margin-right: 1em;"> </textarea>
        </div>
    </form>
</div>
...
<{if $gwiki.preview}><p class="itemInfo"><{$smarty.const._MD_GWIKI_PAGE}>:
    ...
    <br clear="all"/>
    <a href="#<{$gwikiform.name}>"><img src="<{$gwiki.modurl}>/assets/images/upicon.png" alt="<{$smarty.const._MD_GWIKI_BACK_TO_TOP}>"/> <{$smarty.const._MD_GWIKI_BACK_TO_TOP}></a>
<{/if}>
            ...
            <td width="90%">
                ...
                <div class="wikiimagedetail">
                    <form id="wikieditimg_form" action="ajaximgedit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" id="wikieditimg_name" name="wikieditimg_name" size="30" value="" onchange="fieldEventHandler('change','wikieditimg_name');" onfocus="fieldEventHandler('focus','wikieditimg_name');"/>
                        <br/><span class="wikieditimg_field"><{$smarty.const._MD_GWIKI_IMAGES_ALTTEXT}></span>
                        <input type="text" id="wikieditimg_alttext" name="wikieditimg_alttext" size="30" value="" onchange="fieldEventHandler('change','wikieditimg_alttext');" onfocus="fieldEventHandler('focus','wikieditimg_alttext');"/>
                        <br/><span class="wikieditimg_field"> </span>
                        <input type="checkbox" id="wikieditimg_represent" name="wikieditimg_represent" value="represent" onchange="fieldEventHandler('change','wikieditimg_represent');" onfocus="fieldEventHandler('focus','wikieditimg_represent');"/> <{$smarty.const._MD_GWIKI_IMAGES_REPRESENT}>
                        <br/><br/>
            ...
            <td width="90%">
                ...
                <div class="wikifiledetail">
                    <form id="wikieditfile_form" action="ajaxfileedit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <span class="wikieditfile_field" style="display: inline-block; vertical-align: top;"> <textarea id="wikieditfile_description" name="wikieditfile_description" rows="3" cols="40" onchange="fileFieldEventHandler('change','wikieditfile_description');" onfocus="fileFieldEventHandler('focus','wikieditfile_description');"> </textarea></span>
...
<span class="wikieditor-param-value"><button type="button" onclick="processPopFormColor(this.form);"><{$smarty.const.MD_GWIKI_EDIT_BTN_INSERT}></button>
...
<select name="popformheader">
    ...
    <option value="5"><{$smarty.const._MD_GWIKI_EDPOP_HEAD_5}></option>
        ...
        <span class="wikieditor-param-title"> </span>
<span class="wikieditor-param-value"><button type="button" onclick="processPopFormHeader(this.form);"><{$smarty.const.MD_GWIKI_EDIT_BTN_INSERT}></button>
<button type="button" onclick="closeAllParams();"><{$smarty.const.MD_GWIKI_EDIT_BTN_CANCEL}></button>
</span><br/>
    </form>
    <span class="wikieditor-param-bottom"></span>
...
<select name="popformindent">
    ...
    <option value="5"><{$smarty.const._MD_GWIKI_EDPOP_INDENT_5}></option>
        ...
        <span class="wikieditor-param-title"> </span>
<span class="wikieditor-param-value"><button type="button" onclick="processPopFormIndent(this.form);"><{$smarty.const.MD_GWIKI_EDIT_BTN_INSERT}></button>
<button type="button" onclick="closeAllParams();"><{$smarty.const.MD_GWIKI_EDIT_BTN_CANCEL}></button>
</span><br/>
    </form>
    <span class="wikieditor-param-bottom"></span>
...
<select name="popformboxtype">
    ...
    <option value="warning"><{$smarty.const._MD_GWIKI_EDPOP_BXTYPE_WARN}></option>
        ...
        <span class="wikieditor-param-title">Title:</span> <span class="wikieditor-param-value"><input name="popformboxtitle" type="text" size="12">
</span><br/>
        <span class="wikieditor-param-title"> </span>
<span class="wikieditor-param-value"><button type="submit" onclick="processPopFormBoxes(this.form);"><{$smarty.const.MD_GWIKI_EDIT_BTN_INSERT}></button>
<button type="button" onclick="closeAllParams();"><{$smarty.const.MD_GWIKI_EDIT_BTN_CANCEL}></button>
</span><br/>
    </form>
    <span class="wikieditor-param-bottom"></span>
...
<div id="wikieditor-popform-ref" class="wikieditor-param-container">
    ...
    <form action="#" onsubmit="return false;">
        ...
        <span class="wikieditor-param-title"><{$smarty.const._MD_GWIKI_EDPOP_PRMT_REF_ID}></span> <span class="wikieditor-param-value"><input name="popformrefid" type="text" size="12">
</span><br/>

        <div class="wikieditor-param-prompt"><{$smarty.const._MD_GWIKI_EDPOP_XPRMT_REF2}></div>
        <span class="wikieditor-param-title"><{$smarty.const._MD_GWIKI_EDPOP_PRMT_REF_FIRST}></span> <span class="wikieditor-param-value"><input name="popformreffirst" type="text" size="12">
</span><br/>
        <span class="wikieditor-param-title"><{$smarty.const._MD_GWIKI_EDPOP_PRMT_REF_REPEAT}></span> <span class="wikieditor-param-value"><input name="popformrefrepeat" type="text" size="12">
</span><br/>
        <span class="wikieditor-param-title"> </span>
<span class="wikieditor-param-value"><button type="submit" onclick="processPopFormRef(this.form);"><{$smarty.const.MD_GWIKI_EDIT_BTN_INSERT}></button>
<button type="button" onclick="closeAllParams();"><{$smarty.const.MD_GWIKI_EDIT_BTN_CANCEL}></button>
</span><br/>
    </form>
    <span class="wikieditor-param-bottom"></span>
