...
function processPopFormRef(form) {
	var openmarkup = "{ref";
	if(form.popformrefid.value!="") { openmarkup = openmarkup+" "+form.popformrefid.value;}
	if(form.popformreffirst.value!="") {
		if(form.popformrefid.value=="") { openmarkup = openmarkup+" ";}
...
function setCaretPosition(ctrl, pos)
{
	...
	// older IE
	else { setSelection(ctrl, pos, pos); }
}
...
function setEditOnblur() {
	...
	e.onbeforedeactivate=function(){ saveSelectionOnblur(e); };
	b = document.getElementById("body");
	b.onbeforedeactivate=function(){ saveSelectionOnblur(b); };
}
