...
<a href="javascript:ajaxGwikiLoad('<{$block.keyword}>','<{$block.bid}>');"><img src="<{$block.modurl}>/assets/images/homeicon.png" alt="<{$block.display_keyword}>" title="<{$block.display_keyword}>" /></a>
<a href="javascript:ajaxGwikiStackPop('<{$block.bid}>');"><img src="<{$block.modurl}>/assets/images/backicon.png" alt="<{$smarty.const._BACK}>" title="<{$smarty.const._BACK}>" /></a>
<{if $block.mayEdit}><a href="javascript:ajaxGwikiRedirect('edit', '<{$block.keyword}>','<{$block.bid}>');"><img src="<{$block.modurl}>/assets/images/editicon.png" alt="<{$smarty.const._EDIT}>" title="<{$smarty.const._EDIT}>" /></a> <a href="javascript:ajaxGwikiRedirect('history', '<{$block.keyword}>','<{$block.bid}>');"><img src="<{$block.modurl}>/assets/images/historyicon.png" alt="<{$smarty.const._MD_GWIKI_HISTORY}>" title="<{$smarty.const._MD_GWIKI_HISTORY}>" /></a><{/if}>
</div>
<script>
